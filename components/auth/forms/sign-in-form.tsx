    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <Button
          ...
          disabled={isLoading}
          className="w-full bg-transparent border border-background hover:border-bactext-background-500 text-white py-3 rounded-lg flex items-center justify-center space-x-4">
          {googleIcon}
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="w-full text-md bg-white hover:bg-background-100 text-primary py-3 rounded-lg font-semibold">
